 ...
 */
tinymce.PluginManager.requireLangPack("magicline","es,fr_FR"),tinymce.PluginManager.add("magicline",function(e,t){if("string"==typeof e.settings.valid_classes)e.settings.valid_classes+=" nomagicline"
else if("object"==typeof e.settings.valid_classes){var i=e.settings.valid_classes["*"]
e.settings.valid_classes["*"]=void 0!=i?i+" nomagicline":"nomagicline"}e.on("init",function(){function i(e,t){d=parseInt(C.getStyle(e,"border-left-width",!0)),c=parseInt(C.getStyle(e,"border-right-width",!0)),r=parseInt(C.getStyle(e,"padding-left",!0)),g=parseInt(C.getStyle(e,"padding-right",!0)),S=t-z,w=C.getPos(e,D).x,k=C.getSize(e).w,w+=r,k-=r+g,v&&(S-=I),e===D?k-=d+c:(w+=d,k-=d+c,v&&(w-=parseInt(C.getStyle(D,"border-left-width",!0))))}function n(e){if(o=E(e.target),!(o.hasClass("magicline-container")||o.parent(".magicline-container").length>0)){for(u=!1;o.length>0&&o[0]!=D;){if(!o.hasClass("nomagicline")&&P.indexOf(o[0].tagName)>-1){u=!0,l=o
break}o=o.parent()}if(u){if(v="border-box"===C.getStyle(D,"box-sizing",!0),I=parseInt(C.getStyle(D,"border-top-width",!0)),h=C.getPos(o[0],D),b=C.getSize(o[0]),f=e.pageY,N&&(f-=C.getPos(D).y),v||(f-=I),Math.abs(h.y-f)<=z)return p=o.prev(),void((0==p.length||p.hasClass("magicline-container")||P.indexOf(p[0].tagName)>-1)&&(y="top",i(o.parent()[0],h.y),(!D.contains(s)||C.getParents(s).length<=1)&&a(),C.setStyles(s,{top:S+"px",left:w+"px",width:k+"px"}),C.show(s)))
if(Math.abs(h.y+b.h-f)<=z)return m=o.next(),void((0==m.length||m.hasClass("magicline-container")||P.indexOf(m[0].tagName)>-1)&&(y="bottom",i(o.parent()[0],h.y+b.h),(!D.contains(s)||C.getParents(s).length<=1)&&a(),C.setStyles(s,{top:S+"px",left:w+"px",width:k+"px"}),C.show(s)))}C.hide(s)}}function a(){s&&C.remove(s),s=C.create("div",{class:"magicline-container",style:"width: 100%; position: absolute; display: block; top: 0; left: 0; margin: 0; padding: 0; height: "+2*z+"px;-webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;",contentEditable:"false","data-mce-bogus":"1"}),C.add(s,"div",{class:"magicline-dashedline",style:"position:absolute; top: 50%; left: 0; display: block; border: 0; border-top: 1px dashed "+_+"; height: 0; width: 100%; margin: 0; padding: 0;","data-mce-bogus":"1"})
...
"top"===y?l.before(n):l.after(n),e.selection.select(n,!0)}C.hide(s)}),C.hide(s),C.add(D,s)}var s,o,l,r,g,d,c,p,m,h,b,f,u,y,x,v,w,S,k,I,_=e.settings.magicline_color||"#4A8DE0",P=e.settings.magicline_targetedItems||["DIV","IMG"],z=e.settings.magicline_triggerMargin||20,M=e.settings.magicline_insertedBlockTag||"p",E=tinymce.dom.DomQuery,C=e.dom,D=e.$()[0],N=e.settings.inline===!0
